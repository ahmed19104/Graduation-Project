        ...
        <div className="p-5 flex gap-4">
          ...
          <div className="flex-1 min-w-0">
            <div className="flex items-start justify-between gap-2">
              <h3 className="font-bold text-slate-900 truncate group-hover:text-primary-700 transition-colors">
                {guide.name}
              </h3>
            ...
            <div className="flex items-center gap-1 mt-1 text-amber-500">
              ...
              <span className="text-sm font-semibold text-slate-700">{guide.rate?.toFixed(1) || 'New'}</span>
            </div>
